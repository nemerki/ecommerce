                ...
                <div class="widget-content nopadding">
                    <form id="categoryForm" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" value="{{$category->name}}" name="name" class="span11"
                                       required/>
                            </div>
                        </div>
                            ...
                            <div class="controls">
                                <select class="span11" name="ust_id">
                                    ...
                                    @foreach($allCategories as $allCategory)
                                        <option @if($category->ust_id ==$allCategory->id) selected @endif value="{{$allCategory->id}}">{{$allCategory->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-actions text-right">
                            <button type="button" id="categoryUpdate" class="btn btn-success">Kategori Güncelle</button>
                        </div>
                    </form>
                </div>
            </div>
